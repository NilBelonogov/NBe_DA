...
**Задание** 
Исследование альтернативного метода воздействия на клиентские покупки
Формирование таблицы с результатами АБ Теста, построение калькулятора
...
**Результаты**  
Проведенный анализ позволил определить:
- Выявить анмалии в данных (отсутствующие, нулевые, фантомные значения, проблемные города и торговые точки)
- Определить положительный эффект от внедрения новой рекламы
